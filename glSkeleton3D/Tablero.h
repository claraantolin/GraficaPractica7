...
class Tablero : public Malla
{
   ...
   public:           
        ...
        Tablero();
        Tablero(GLdouble r, GLdouble g, GLdouble b, GLdouble largo, GLdouble ancho, GLdouble alto, GLdouble divL, GLdouble divAn, GLdouble divAl, TAfin* a):Malla(new Color(r,g,b),0,new Lista<PV3D*>(), 0, new Lista<PV3D*>(), 0, new Lista<Cara*>(), a){
